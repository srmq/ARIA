...
<tagfile>
  ...
  <compound kind="class">
    ...
    <member kind="function">
      ...
      <name>ArServerModeWander</name>
      <anchorfile>classArServerModeWander.html</anchorfile>
      <anchor>a70afc17fc2eaddf6525c4f247a48f045</anchor>
      <arglist>(ArServerBase *server, ArRobot *robot, int forwardVel=400, int avoidFrontDist=450, int avoidVel=200, int turnAmt=15)</arglist>
    </member>
    <member kind="function" virtualness="virtual">
      <type>virtual void</type>
      <name>checkDefault</name>
