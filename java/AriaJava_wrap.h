...
public:
    ...
    virtual void mapChanged(bool invokePathPlanningCB, bool invokeLocalizationCB);
    ...
    virtual void addMapChangedPathPlanningCB(ArFunctor *functor, int position = 50);
    virtual void remMapChangedPathPlanningCB(ArFunctor *functor);
    virtual void addMapChangedLocalizationCB(ArFunctor *functor, int position = 50);
    virtual void remMapChangedLocalizationCB(ArFunctor *functor);
    ...
    virtual void addPreParseFileCB(ArFunctor1< std::string > *functor);
    virtual void remPreParseFileCB(ArFunctor1< std::string > *functor);
    ...
    virtual char const *getMapCategory();
    ...
    virtual void offsetMapContents(ArPose const &offset);
...
public:
    bool swig_overrides(int n) {
      return (n < 150 ? swig_override[n] : false);
    }
protected:
    Swig::BoolArray<150> swig_override;
};
